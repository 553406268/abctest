...
namespace scsjgl
{
    public partial class SuiGongDanJTXX : Form
    {
        ...
        public SuiGongDanJTXX(Login1 form1)
        {
            frmOne = form1;
            InitializeComponent();
        }
                ...
                if (result == true)
                {
                    ...
                    if (this.tbDXH1.Text != "")
                    {
                        ...
                        if (yh.工序名称 == "全部")
                        {
                            ...
                            if (lry1 == null || lry1 == "0")
                            {
                                this.tblry.Text = frmOne.txtUserName.Text;
                            ...
                            if (lry2 == "" || lry2 == "0")
                            {
                                this.tblr1.Text = frmOne.txtUserName.Text;
                            ...
                            if (lry3 == "" || lry3 == "0")
                            {
                                this.tblr2.Text = frmOne.txtUserName.Text;
                            ...
                            if (lry4 == "" || lry4 == "0")
                            {
                                this.tblr3.Text = frmOne.txtUserName.Text;
                            ...
                            if (lry5 == "" || lry5 == "0")
                            {
                                this.tblr4.Text = frmOne.txtUserName.Text;
                            ...
                            if (lry6 == "" || lry6 == "0")
                            {
                                this.tblr5.Text = frmOne.txtUserName.Text;
                            ...
                            if (lry7 == "" || lry7 == "0")
                            {
                                this.tblr6.Text = frmOne.txtUserName.Text;
                            ...
                            if (lry8 == "" || lry8 == "0")
                            {
                                this.tblr7.Text = frmOne.txtUserName.Text;
